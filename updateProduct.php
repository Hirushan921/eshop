                ...
                <div id="updateproductbox">
                    ...
                    <div class="row">
                        <div class="offset-o offset-lg-1 col-12 col-lg-6">
                            <input type="text" class="form-control" placeholder="Search Product You Want To Update" id="searchToUpdate" />
                        </div>
                        <div class="col-12 col-lg-4 d-grid">
                            <button class="btn btn-primary mt-2 mt-lg-0" onclick="searchtoupdate();">Search Product</button>
                        </div>
                    </div>
                </div> -->
                    <!-- search field  -->
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <?php
                            $details = Database::search("SELECT product.id AS pid,brand.name AS bname,model.name AS mname, 
                          color.id AS cid,color.name AS cname,condition.id AS conid FROM product 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <select class="form-select" id="br" disabled>
                                            <option value="0"><?php echo $data["bname"]; ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <select class="form-select" id="mo" disabled>
                                            <option value="0"><?php echo $data["mname"]; ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                        <div class="form-check offset-lg-1 offset-1 col-5 col-lg-3">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="bn" disabled checked>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <?php
                                            $clr = Database::search("SELECT * FROM `color` WHERE `id`!='" . $data["cid"] . "'");
                                            $clrn = $clr->num_rows;
                                            for ($b = 0; $b < $clrn; $b++) {
                                                $clrname = $clr->fetch_assoc();
                                            ?>
                                                <div class="form-check col-lg-4 offset-lg-0 col-5 offset-1">
                                                    <input class="form-check-input" type="radio" name="clrradio" id="clr1" disabled>
                                                    <label class="form-check-label" for="clr1">
                                                        <?php echo $clrname["name"];  ?>
                                                    </label>
                                                </div>
                                            <?php
                                            }
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <textarea class="form-control" cols="100" rows="30" style="background-color: honeydew;" id="desc"><?php echo $product["description"]; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- description -->
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <?php
                            $pimg = Database::search("SELECT * FROM `images` WHERE `product_id`='" . $data["pid"] . "'");
                            $img = $pimg->fetch_assoc();
                            ?>
                            <img src="<?php echo $img["code"] ?>" class="col-5 col-lg-2 ms-2 img-thumbnail" id="prev" />
                    ...
                    <div class="offset-0 offset-lg-4 col-12 col-lg-4 mb-4 d-grid">
                        <button class="btn btn-success searchbtn" onclick="updateProduct();">Update Product</button>
                    </div>
